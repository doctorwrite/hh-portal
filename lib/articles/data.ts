...
export const ARTICLES: Record<string, ArticleData> = {
  ...
  'compression': { title: 'Компрессия в музыке — что это?', description: 'Компрессия — это сжатие динамического диапазона.', content: '<p>Содержание статьи о компрессии будет добавлено позже.</p>' },
  'reverb': { title: 'Реверберация (Reverb) — что это?', description: 'Реверберация — это эффект постепенного затухания звука.', content: '<p>Содержание статьи о реверберации будет добавлено позже.</p>' },
  'delay': { title: 'Дилей (Delay) — что это?', description: 'Дилей — это эффект задержки звука с повторами.', content: '<p>Содержание статьи о дилее будет добавлено позже.</p>' },
  'saturation': { title: 'Сатурация — что это?', description: 'Сатурация — это эффект лёгкого искажения и насыщения звука.', content: '<p>Содержание статьи о сатурации будет добавлено позже.</p>' },
  'limiter': { title: 'Лимитер — что это?', description: 'Лимитер — это жёсткое ограничение уровня сигнала.', content: '<p>Содержание статьи о лимитере будет добавлено позже.</p>' },
  'stereo': { title: 'Стереопанорама — что это?', description: 'Стереопанорама — это пространственное представление звука.', content: '<p>Содержание статьи о стереопанораме будет добавлено позже.</p>' },
  'lufs': { title: 'LUFS — что это?', description: 'LUFS — это единица измерения воспринимаемой громкости.', content: '<p>Содержание статьи о LUFS будет добавлено позже.</p>' },
  'bit-depth': { title: 'Битность (Bit Depth) — что это?', description: 'Битность — это количество бит для представления каждого сэмпла.', content: '<p>Содержание статьи о битности будет добавлено позже.</p>' },
  'sample-rate': { title: 'Частота дискретизации (Sample Rate) — что это?', description: 'Частота дискретизации — это количество измерений звука в секунду.', content: '<p>Содержание статьи о частоте дискретизации будет добавлено позже.</p>' },
  'midi': { title: 'MIDI — что это?', description: 'MIDI — это цифровой протокол для связи музыкальных инструментов.', content: '<p>Содержание статьи о MIDI будет добавлено позже.</p>' },
  'audio-interface': { title: 'Аудиоинтерфейс — что это?', description: 'Аудиоинтерфейс — это устройство для преобразования аналогового звука в цифровой.', content: '<p>Содержание статьи об аудиоинтерфейсе будет добавлено позже.</p>' },
  'vst': { title: 'VST / Плагины — что это?', description: 'VST — это формат плагинов для обработки звука.', content: '<p>Содержание статьи о VST будет добавлено позже.</p>' },
  'sample': { title: 'Сэмпл (Sample) — что это?', description: 'Сэмпл — это цифровая запись звука.', content: '<p>Содержание статьи о сэмплах будет добавлено позже.</p>' },
  'monitors': { title: 'Студийные мониторы — что это?', description: 'Студийные мониторы — это акустические системы с нейтральным звуком.', content: '<p>Содержание статьи о студийных мониторах будет добавлено позже.</p>' },
  'midi-controller': { title: 'MIDI-контроллер — что это?', description: 'MIDI-контроллер — это устройство для управления виртуальными инструментами.', content: '<p>Содержание статьи о MIDI-контроллере будет добавлено позже.</p>' },
  'mixing': { title: 'Как работает сведение (Mixing)?', description: 'Сведение — это процесс объединения и балансировки всех дорожек.', content: '<p>Содержание статьи о сведении будет добавлено позже.</p>' },
  'mastering': { title: 'Как работает мастеринг (Mastering)?', description: 'Мастеринг — это финальный этап обработки трека.', content: '<p>Содержание статьи о мастеринге будет добавлено позже.</p>' },
  'bitrate': { title: 'Битрейт (Bitrate) — что это?', description: 'Битрейт — это количество данных в единицу времени.', content: '<p>Содержание статьи о битрейте будет добавлено позже.</p>' },
  'filter': { title: 'Фильтр (HPF, LPF) — что это?', description: 'Фильтры для очистки звука от ненужных частот.', content: '<p>Содержание статьи о фильтрах будет добавлено позже.</p>' },
  'clipping': { title: 'Цифровой клиппинг: что это и как избежать', description: 'Клиппинг — это искажения из-за перегрузки сигнала.', content: '<p>Содержание статьи о клиппинге будет добавлено позже.</p>' },
  'phase': { title: 'Фазокоррекция — что это?', description: 'Фазокоррекция — это выравнивание фазы звуковых сигналов.', content: '<p>Содержание статьи о фазокоррекции будет добавлено позже.</p>' },
  'tracking': { title: 'Трекинг (Tracking) — как проходит запись', description: 'Трекинг — это процесс записи звука на дорожки.', content: '<p>Содержание статьи о трекинге будет добавлено позже.</p>' },
  'editing': { title: 'Монтаж (Editing) — склейка и правка', description: 'Монтаж — это редактирование записанного материала.', content: '<p>Содержание статьи о монтаже будет добавлено позже.</p>' },
  'automation': { title: 'Автоматизация в сведении', description: 'Автоматизация — это изменение параметров во времени.', content: '<p>Содержание статьи об автоматизации будет добавлено позже.</p>' },
  'prepare-tracks': { title: 'Как подготовить дорожки для сведения', description: 'Подготовка дорожек — важный этап перед сведением.', content: '<p>Содержание статьи о подготовке дорожек будет добавлено позже.</p>' },
  'vocal-mix-minus': { title: 'Сведение голоса с минусом', description: 'Сведение голоса с минусом — это баланс вокала и инструментов.', content: '<p>Содержание статьи о сведении голоса с минусом будет добавлено позже.</p>' },
  'parallel-compression': { title: 'Параллельная компрессия', description: 'Параллельная компрессия — это смешивание сжатого и исходного сигнала.', content: '<p>Содержание статьи о параллельной компрессии будет добавлено позже.</p>' },
  'sidechain': { title: 'Сайд-чейн', description: 'Сайд-чейн — это техника, при которой один сигнал управляет компрессором на другом.', content: '<p>Содержание статьи о сайд-чейне будет добавлено позже.</p>' },
  'depth-width': { title: 'Как создать ширину и глубину в миксе', description: 'Ширина и глубина — это пространственные характеристики микса.', content: '<p>Содержание статьи о ширине и глубине будет добавлено позже.</p>' },
  'recording-mistakes': { title: 'Ошибки в записи, которые убивают сведение', description: 'Ошибки при записи могут испортить весь микс.', content: '<p>Содержание статьи об ошибках в записи будет добавлено позже.</p>' },
  'eq-vocal': { title: 'Как настроить эквалайзер под конкретный голос', description: 'Настройка эквалайзера для вокала — ключевой навык.', content: '<p>Содержание статьи о настройке EQ для вокала будет добавлено позже.</p>' },
  'rap-vocal': { title: 'Особенности сведения рэп-вокала', description: 'Сведение рэп-вокала имеет свои особенности.', content: '<p>Содержание статьи о сведении рэп-вокала будет добавлено позже.</p>' },
  'vocal-processing': { title: 'Продвинутая обработка вокала', description: 'Продвинутая обработка вокала — это профессиональные техники.', content: '<p>Содержание статьи о продвинутой обработке вокала будет добавлено позже.</p>' },
  'rock-guitar': { title: 'Особенности сведения рока и металла', description: 'Сведение рока и металла требует особого подхода.', content: '<p>Содержание статьи о сведении рока и металла будет добавлено позже.</p>' },
  'bass-mixing': { title: 'Как добиться плотного баса в миксе', description: 'Плотный бас — основа хорошего микса.', content: '<p>Содержание статьи о плотном басе будет добавлено позже.</p>' },
  'harmonics': { title: 'Гармоники', description: 'Гармоники — это дополнительные частоты, обогащающие звук.', content: '<p>Содержание статьи о гармониках будет добавлено позже.</p>' },
  'philosophy': { title: 'Наша философия', description: 'Философия студии HHRecords.', content: '<p>Содержание статьи о философии студии будет добавлено позже.</p>' },
  'gear-case': { title: 'Наше оборудование', description: 'Оборудование студии HHRecords.', content: '<p>Содержание статьи об оборудовании студии будет добавлено позже.</p>' },
  'case1': { title: 'Кейс: как мы спасли трек с плохим вокалом', description: 'Реальный кейс спасения трека.', content: '<p>Содержание кейса будет добавлено позже.</p>' },
  'case2': { title: 'Кейс: как мы спасли трек с плохим гитарным звуком', description: 'Реальный кейс спасения трека с плохим гитарным звуком.', content: '<p>Содержание кейса будет добавлено позже.</p>' },
  'case3': { title: 'Кейс: мастеринг за 2 часа (срочный заказ)', description: 'Реальный кейс срочного мастеринга.', content: '<p>Содержание кейса будет добавлено позже.</p>' },
  'case4': { title: 'Кейс: как мы работали с рэп-исполнителем', description: 'Реальный кейс работы с рэп-исполнителем.', content: '<p>Содержание кейса будет добавлено позже.</p>' },
  'case5': { title: 'Кейс: работа с "сырым" материалом', description: 'Реальный кейс работы с "сырым" материалом.', content: '<p>Содержание кейса будет добавлено позже.</p>' },
  'case6': { title: 'Кейс: создание "полного" и мощного звука', description: 'Реальный кейс создания "полного" и мощного звука.', content: '<p>Содержание кейса будет добавлено позже.</p>' },
}
