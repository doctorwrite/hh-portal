...
export const eq: ArticleData = {
  ...
  toc: [
    { id: 'q1', label: 'Что такое эквализация?' },
    { id: 'q2', label: 'Виды эквализации' },
    { id: 'q3', label: 'Где применяется' },
    { id: 'q4', label: 'Типы эквалайзеров' },
    { id: 'q5', label: 'Принципы настройки' },
    { id: 'q6', label: 'Ошибки при эквализации' },
  ],
  ...
  qa: [
    ...
    {
      id: 'q2',
      question: 'Какие бывают виды эквализации?',
      answer: `
    ...
    {
      id: 'q4',
      question: 'Какие бывают типы эквалайзеров?',
      answer: `
    ...
    {
      id: 'q5',
      question: 'Какие важные принципы настройки эквалайзера?',
      answer: `
        <ul>
    ...
    {
      id: 'q6',
      question: 'Какие ошибки часто допускают при эквализации?',
      answer: `
        <ul>
