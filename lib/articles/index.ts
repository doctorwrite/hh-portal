...
export const CompressorWidget = dynamic(() => import('./CompressorWidget'), {
  ssr: false,
  loading: () => (
    <div style={{
      display: 'flex',
...
export const ReverbWidget = dynamic(() => import('./ReverbWidget'), {
  ssr: false,
  loading: () => (
    <div style={{
      display: 'flex',
...
export const DelayWidget = dynamic(() => import('./DelayWidget'), {
  ssr: false,
  loading: () => (
    <div style={{
      display: 'flex',
