          ...
          <div className="seo-grid">
            <div className="seo-main">
              <h2 className="seo-heading">
                📚 Энциклопедия звукозаписи HHRecords
              </h2>
              <p className="seo-lead">
                Крупнейший русскоязычный сборник статей по <strong>сведению, мастерингу, 
                эквализации, компрессии, реверберации, дилею, сатурации, лимитеру, 
                стереопанораме, LUFS, битности, частоте дискретизации, MIDI, 
                аудиоинтерфейсам, VST-плагинам, сэмплам, студийным мониторам и MIDI-контроллерам.</strong>
              </p>
              <p>
            ...
            <div className="seo-questions">
              <ul className="seo-list">
                <li>🔹 Как настроить эквалайзер под голос?</li>
                <li>🔹 Как работает компрессор?</li>
                <li>🔹 Что такое LUFS и зачем он нужен?</li>
                <li>🔹 Как выбрать аудиоинтерфейс?</li>
                <li>🔹 Как сделать сведение вокала с минусом?</li>
                <li>🔹 Как добиться плотного баса в миксе?</li>
                <li>🔹 Как работает параллельная компрессия?</li>
                <li>🔹 Что такое сайд-чейн?</li>
              </ul>
            </div>
          </div>
          <div className="seo-footer">
            <p>
              <strong>Энциклопедия создана студией звукозаписи HHRecords в Красноярске</strong>, 
              которая работает с 2016 года. Мы записываем и сводим треки для артистов со всей России.
            </p>
          </div>
        </div>
      </section>
