...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Профессиональная студия звукозаписи в Красноярске. Запись вокала, сведение, мастеринг. Оборудование Neumann, Focal, Apollo.',
    siteName: 'HHRecords',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'HHRecords — Студия звукозаписи в Красноярске',
    description:
      'Профессиональная студия звукозаписи. Запись вокала, сведение, мастеринг.',
  ...
  alternates: {
    canonical: 'https://hiphoprecords.ru',
  },
  category: 'music',
}
...
const jsonLdLocalBusiness = {
  ...
  address: {
    '@type': 'PostalAddress',
    streetAddress: 'ул. Дудинская 3с5, 3 этаж, офис 311',
    ...
    <html lang="ru" className={`${montserrat.variable} ${oswald.variable}`}>
      <head>
        ...
        <noscript>
          <div>
            <img
              src="https://mc.yandex.ru/watch/98989584"
          ...
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                ...
                const totalNotes = isMobile ? 6 : 15;
                const symbols = ['♪', '♫', '🎸', '🎧', '🎙️', '🎛️'];
                function createNote() {
                ...
                for (let i = 0; i < totalNotes; i++) setTimeout(createNote, Math.random() * 3000);
                setInterval(createNote, isMobile ? 5000 : 3000);
              })();
            `,
          }}
        />
